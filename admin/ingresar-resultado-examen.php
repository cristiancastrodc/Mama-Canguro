...
<html>
  <head>
    <!-- General -->
    <meta charset="utf-8">
    <title>Ingresar Resultado de Laboratorio | Administrador </title>
          ...
          <div class="row mt">
            <div class="col-lg-12">
              <div class="content-panel">
                <h3>&nbsp;<i class="fa fa-angle-double-right"></i> Exámenes sin resultado</h3>
                <?php
                  _print_examenes_sin_resultado($conexion);
                ?>
              </div>
            </div>
          </div>
