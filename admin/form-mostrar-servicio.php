  ...
  */
  ...
  echo "<div class='form-group'>";
    ...
    echo "<div class='col-sm-4'>";
      echo "<input type='text' class='form-control round-form uppercase' id='txtNombreEsp' name='txtNombreEsp' readonly value='$denominacion'></input>";
    echo "</div>";
  echo "</div>";
  ...
  echo "<div class='form-group'>";
    ...
    echo "<div class='col-lg-4'>";
      echo "<input type='text' class='form-control round-form right-align' value='$precio' id='txtPrecio' name='txtPrecio' ";
      if (intval(substr($precio, 3)) == 0) {
        echo ">";
      } else {
        echo "readonly>";
      }
  ...
  echo "<div class='form-group'>";
    ...
    echo "<div class='col-lg-4'>";
      echo "<input type='text' class='form-control round-form right-align' readonly id='txtTotal' name='txtTotal'>";
    echo "</div>";
  echo "</div>";
