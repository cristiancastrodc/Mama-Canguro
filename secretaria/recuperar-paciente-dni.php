<?php
  ...
  if ($nro_filas > 0) {
      ...
      echo "<input type='hidden' id='txtdocid' name='txtdocid' value='".$fila['chr_doc_id']."'>";
      ...
      echo "<div class='form-group'>";
        ...
        echo "<div class='col-lg-1'>";
          echo "<input type='number' min='1' max='31' class='form-control round-form' id='txtDia' name='txtDia' value='$dia_nacimiento' required placeholder='dd'>";
        echo "</div>";
        echo "<div class='col-lg-1'>";
          echo "<input type='number' min='1' max='12' class='form-control round-form' id='txtMes' name='txtMes' value='$mes_nacimiento' required placeholder='mm'>";
        echo "</div>";
        echo "<div class='col-lg-2'>";
          echo "<input type='number' min='1900' class='form-control round-form' id='txtYear' name='txtYear' value='$year_nacimiento' required placeholder='aaaa'>";
        echo "</div>";
        $hoy = date('Y');
        ...
        echo "<div class='col-lg-4'>";
          echo "<input type='text' class='form-control round-form' id='txtedad' name='txtedad' value='$edad' readonly=0>";
        echo "</div>";
      echo "</div>";
      echo "<div class='form-group'>";
      ...
      echo "<div class='form-group'>";
        ...
        echo "</div>";
      echo "</div>";
      echo "<button type='submit' class='btn btn-block btn-lg btn-success' accesskey='g'>GUARDAR (Alt + G)</button>";
  	}
  }
  else{
    echo "<div class='alert alert-warning center-align'><b>Paciente no encontrado!</b> Por favor, búsquelo por su nombre.</div>";
  }
